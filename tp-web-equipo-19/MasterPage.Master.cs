...
namespace tp_web_equipo_19
{
    public partial class Site1 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!(Page is Default  || Page is Carrito || Page is DetalleArticulo || Page is login || Page is Registro || Page is RegistroEnvio || Page is RegistroConfirmación || Page is RecuperarContraseña1 || Page is RecuperarContraseña2 || Page is RecuperarContraseña3))
            {
